...
namespace onlineshop.Migrations
{
    ...
    [Migration("20250308124526_adding_payment_table")]
    partial class adding_payment_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("onlineshop.Models.T_Payment", b =>
                {
            ...
            modelBuilder.Entity("onlineshop.Models.T_TempBasket", b =>
                {
                    b.Property<Guid>("ID_TempBasket")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("T_tempOrder_ID")
                        .HasColumnType("uniqueidentifier");

                    b.Property<long>("TotalPrice")
                        .HasColumnType("bigint");

                    b.HasKey("ID_TempBasket");

                    b.HasIndex("T_Product_ID");

                    b.HasIndex("T_tempOrder_ID");

                    b.ToTable("T_TempBasket");
                });

            modelBuilder.Entity("onlineshop.Models.T_TempOrder", b =>
                {
                    b.Property<Guid>("ID_TempOrder")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ID_TempOrder");

                    b.ToTable("T_TempOrder");
                });
            ...
            modelBuilder.Entity("onlineshop.Models.T_TempBasket", b =>
                {
                    ...
                    b.HasOne("onlineshop.Models.T_TempOrder", "TempOrder")
                        .WithMany("Items")
                        .HasForeignKey("T_tempOrder_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
